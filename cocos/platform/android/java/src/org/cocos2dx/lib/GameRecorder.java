...
import org.cocos2dx.lib.InputSurface;
...
public class GameRecorder {
    ...
    public void prepareEncoder(Context context) {
        ...
        mOutputFile = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath(), "videox.mp4");
    ...
    private void configureViewport() {
        Cocos2dxGLSurfaceView surfaceView = Cocos2dxGLSurfaceView.getInstance();
        int width = surfaceView.getWidth();
        int height = surfaceView.getHeight();

        float arenaRatio = (float)height/(float)width;
